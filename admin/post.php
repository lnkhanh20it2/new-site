                      ...
                      <tbody>
                         <?php  while($row = mysqli_fetch_assoc($result)) {?>
                            <tr>
                              ...
                              <td class='delete'><a href='delete-post.php?id=<?php echo $row['post_id'];?>&category_id=<?php echo $row['category'];?>'><i class='fa fa-trash-o'></i></a></td>
                          </tr>
                       <?php } ?>
                  </table>
                  <?php 
